...
4.Use the buttons on each task card to:
...
Test Cases (Manual)
Some example manual test cases:
TC1 – Create task
...
License:
his project was created for educational purposes as part of the IU module
DLBCSPJWD01 – Java and Web Development.

4. Press **Ctrl + S** to save.

✅ That’s all you need to “do” for this part.  
Your README now has **usage instructions, test cases, tech stack, license** – exactly what the professor wanted.

---

## 3️⃣ CSS snippet (separate from README)

The CSS block you pasted at the end of your message is **not** for README.  
You put it in **`styles.css`**:

1. Open `src/main/resources/static/styles.css` in VS Code.
2. Scroll to the very bottom of the file.
3. Paste this there:

```css
/* Buttons on each task card */
.task-actions button {
...
/* On small screens make buttons larger and stacked */
